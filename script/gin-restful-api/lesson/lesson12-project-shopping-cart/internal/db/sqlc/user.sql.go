...
VALUES ($1, $2, $3, $4, $5, $6)
RETURNING user_id, user_uuid, user_email, user_password, user_full_name, user_age, user_status, user_level, user_deleted_at, user_created_at, user_updated_at
`
...
SELECT user_id, user_uuid, user_email, user_password, user_full_name, user_age, user_status, user_level, user_deleted_at, user_created_at, user_updated_at
FROM users
WHERE user_email = $1
...
UPDATE users
SET user_password  = COALESCE($1, user_password),
